...
const people = [
    {name: 'Eustachijus', surname: 'Vamzdys', age: 22, height: 181, weight: 75, sex: 'male'},
    {name: 'Kaspisija', surname: 'Vamzdienė', age: 20, height: 175, weight: 65, sex: 'female'},
    {name: 'Redžinaldas', surname: 'Kiaušinis', age: 45, height: 190, weight: 85, sex: 'male'},
    {name: 'Fortūnata', surname: 'Kiaušinienė', age: 43, height: 180, weight: 90, sex: 'female'},
    {name: 'Kryžmatas', surname: 'Atsuktuvinskas', age: 35, height: 176, weight: 88, sex: 'male'},
    {name: 'Skirmantas', surname: 'Rakovė', age: 75, height: 162, weight: 71, sex: 'male'},
    {name: 'Auksinis', surname: 'Kardas', age: 15, height: 185, weight: 79, sex: 'male'},
    {name: 'Auksinė', surname: 'Žvaigždė', age: 18, height: 155, weight: 60, sex: 'female'},
];
